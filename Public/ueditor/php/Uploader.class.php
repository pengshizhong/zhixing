...
class Uploader
{
    ...
    private function upFile()
    {
        ...
        // $bucket = 'zhixing-images'; //我已经在百度平台建好了这个bucket,就像创建目录一样
        // $object = '/article/'. $this->fileName; //保存到百度云的文件名
        ...
        //         }
        //         $this->fullName='http://bcs.duapp.com/'.BUCKET_NAME.'/'.$this->fullName;
        //     }else{
        //         $this->stateInfo = $this->getStateInfo( "MOVE" );
        // }
            $storage = new SaeStorage();
             $domain = 'public';
             $destFileName = '/article/' . $this->fileName;
             $srcFileName = $file['tmp_name'];
             $this->fullName = $storage->upload($domain,$destFileName, $srcFileName, -1,'', true);
